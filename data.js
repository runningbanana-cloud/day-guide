...
const FLAEMMCHEN_TAEGLICH = [
  ...
  "80 Sit-ups",
  "1 Minute Unterarmstütz (Plank), mehrfach wiederholt",
  "Eine kalte Aussenluft-Runde (5 Minuten draussen ohne Jacke)",
  "Handy auf Graustufen stellen, für den ganzen Tag",
  "Ein Selfcare-Ding machen (Gesichtsmaske, Nägel, o.ä.)",
  "Alle Benachrichtigungen für einen Tag ausschalten",
  "Ein Video/Tutorial zu etwas Nützlichem statt Unterhaltung schauen",
  "Eine Reihe Klimmzüge/Liegestütze bis zum Muskelkater",
  "Jemandem im Bus/auf der Strasse freundlich lächeln oder grüssen",
  "Dein Zimmer für 10 Minuten lüften und dabei aufräumen",
  "Ein Wort des Tages nachschlagen und in einem Satz benutzen",
  "Ein Zoom-Meeting/Gespräch stehend statt sitzend führen",
  "3 Dinge aufschreiben, die heute gut gelaufen sind",
  "Eine App vom Handy löschen, die du zu oft nutzt",
  "Ein Getränk mit Zucker durch Wasser ersetzen",
  "Einen Toilettengang ohne Handy überstehen",
  "Jemandem in der Klasse aktiv helfen, der/die etwas nicht versteht",
  "Ein Musikstück/Podcast in einer anderen Sprache hören",
  "Deine Hausaufgaben für morgen schon heute Abend erledigen",
  "Ein Kompliment an dich selbst aufschreiben",
  "10 Minuten früher als sonst ins Bett gehen",
];
const FLAEMMCHEN_WOECHENTLICH = [
  ...
  "Einen Screenshot der wöchentlichen Bildschirmzeit anschauen und reflektieren",
  "Eine Mahlzeit für die Woche selbst vorkochen (Meal Prep)",
  "Ein Ordnungssystem für Schulunterlagen einrichten oder pflegen",
  "Jemandem, den du lange nicht gesehen hast, einen Besuch abstatten",
  "Eine ganze Woche lang jeden Tag das Bett machen",
  "Ein neues Gericht ohne Rezept ausprobieren",
  "Eine Stunde für ein Hobby reservieren, das sonst zu kurz kommt",
  "Deinen Wochenplan für die nächste Woche im Voraus grob skizzieren",
  "Einen Spaziergang/Lauf ohne Musik/Podcast machen",
  "Eine Sache reparieren, die schon länger kaputt ist",
  "Ein Gespräch führen, das du schon länger aufschiebst",
  "Freiwillig eine zusätzliche Aufgabe zu Hause übernehmen",
];
const FLAEMMCHEN_MONATLICH = [
  ...
  "Eine Fähigkeit einen ganzen Monat lang täglich üben (z. B. Instrument, Sprache)",
  "Einen Kurs/Workshop/eine Veranstaltung zu etwas Neuem besuchen",
  "Eine grössere Aufräumaktion (Keller, Schrank, Kleidung spenden)",
  "Einen Monatsrückblick schreiben: was lief gut, was würdest du ändern",
  "Ein finanzielles Sparziel für den Monat setzen und einhalten",
  "Jemandem in der Familie/Freundeskreis aktiv eine Freude machen",
  "Ein digitales Detox-Wochenende einlegen",
  "Deine Notizen/Unterlagen aus dem letzten Monat komplett aufarbeiten",
];
